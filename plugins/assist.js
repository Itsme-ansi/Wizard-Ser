...
let handler  = async (m, { itsu, usedPrefix: _p }) => {
  ...
  let pp = 'https://telegra.ph/file/7021fa47e29c4798dd1a2.jpg'
  try {
...
let ucapWaktu = waktu > 2 && waktu < 4 ? 'Dini Hari' : waktu < 11 ? 'Good Morning🌄' : waktu < 16 ? 'Good Afternoon☀️' : waktu < 19 ? 'Good Afternoon🌇' : 'Good Night🌙'
